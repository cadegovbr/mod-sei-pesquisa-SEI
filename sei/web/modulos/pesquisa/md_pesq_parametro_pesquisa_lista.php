                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-11">
                            ...
                            <label id="lblCapcthaPesquisaNao" for="chkCapcthaPesquisaNao"
                                   class="infraLabelRadio">Não</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-11">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-10 col-xl-10">
                <fieldset class="infraFieldset sizeFieldset form-control" style="height: auto">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-11">
                            <h6>Habilitar a exibição dos Andamentos nos processos com nível de
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-11">
                            <h6>Habilitar a exibição dos Andamentos nos processos com nível de acesso global
                                "Público":</h6>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-11">
                            <h6>Habilitar o acesso aos metadados dos Processos com nível de
                                acesso global "Restrito"</h6>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-11">
                            <h6>Descrição de justificativa de restrição de acesso e
                                orientações para meios alternativos de solicitação de acesso:</h6>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-10 col-xl-10">
                <fieldset class="infraFieldset sizeFieldset form-control" style="height: auto">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-11">
                            <h6>Habilitar a pesquisa em Documentos que estão associados à
                                processos com nível de acesso global "Público":</h6>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-11">
                            <h6>Habilitar o acesso aos Documentos nos processos com nível de
                                acesso global "Público":</h6>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-10 col-xl-10">
                <fieldset class="infraFieldset sizeFieldset form-control" style="height: auto">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-11">
                            <h6>Habilitar a função auto completar no campo "Interessado /
                                Remetente" na página principal da Pesquisa Pública:</h6>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-11">
                            <h6>Habilitar o link da pesquisa pública no menu de usuário
                                externo:</h6>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-11">
                            <h6>Chave para criptografia dos links de processos e
                                documentos: <img src="<?= PaginaSEI::getInstance()->getDiretorioSvgGlobal() ?>/ajuda.svg" name="ajuda" <?= PaginaSEI::montarTitleTooltip("Este campo deve estar preenchido para que a página da Pesquisa Pública do SEI possa funcionar.\n\nNão utilize a mesma Chave em ambientes do SEI distintos, não divulgue esta Chave para terceiros e se alterar esta Chave todos os links já existentes que usuários tenham não funcionarão. \n\n\n\n\n\n Defina uma Chave forte, preferencialmente maior que 12 caracteres, utilizando letras maiúsculas e minúsculas, números e caracteres especiais.", 'Ajuda') ?> alt="Ajuda" class="infraImgModulo"/></h6>
